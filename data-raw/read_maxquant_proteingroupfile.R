...
#' @param null.zeros boolean. If TRUE, convert zero intensities to NA. Default TRUE
#' @param log2.transform boolean specifying whether to log2 transform the intensities. Default TRUE
#' @param is.label.free boolean indicating whether the Max Quant run is label free
#' @param is.gzip.file boolean indicating whether the file is gzipped (*.gz)
#' @return a list with the following elements: prot.table (the data table) and prot.colnms (the data column names indexed with datacolumnprefix parameter)
#' @export
