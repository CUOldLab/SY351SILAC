---
title: "Generation of input files (and downstream analysis) for motif analysis using MoMo for Syros SY-351 1h HL-60 SILAC phosphoproteome data"
...
dnseqdf <- psitestats %>% dplyr::filter(adj.P.Val.nullfiltisotope < adj_pval_thresh &
                              logFC.nullfiltisotope <  -log2fc_thresh) %>% 
  select(ID,gene.psite, gene.psite.kinase,Seqwin , Sequence.window)
